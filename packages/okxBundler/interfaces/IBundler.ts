...
export interface IBundlerClient {
  ...
  // getInitCode(chainId: number, factory: Address, salt: number, safeSingleton: Address, initializer: Address, validatorTemplate: Address): Promise<Hex>;
  ...
  // getNonce(chainId: number, sender:Address, owner: Address, singleton: Address, key?: bigint): Promise<Hex>;
